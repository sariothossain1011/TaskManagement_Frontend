...
import {AiOutlineCheckCircle, AiOutlineEdit, AiOutlineMenuUnfold, AiOutlineUser} from "react-icons/ai";
import {BsHourglass, BsListNested} from "react-icons/bs";
import { NavLink } from 'react-router-dom';
import LogoImg from '../../Assets/Images/sariot.jpg'
import {getUserDetails, removeSessions} from "../../Helpers/SessionalHelper";
                    ...
                    <Navbar.Brand>
                        ...
                        <div className="float-right h-auto d-flex">
                            <div className="user-dropdown">
                                <img  src={getUserDetails()['photo']}  alt="" className="icon-nav-img icon-nav" />
                                <div className="user-dropdown-content">
                                    <div className="mt-4 text-center">
                                        <img src={getUserDetails()['photo']} className='icon-nav-img' />

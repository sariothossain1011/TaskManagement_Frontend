...
import { RecoverResetPassRequest } from '../../ApiSevices/ApiSevices';
import { ErrorTost, IsPassword } from '../../Helpers/Validation';
...
const CreatePassword = () => {
  ...
  const ResetPass =()=>{
    ...
    if(IsPassword(newPassword)){
      ErrorTost("New Password Must ne Strong")
          ...
          <div className="col-md-7 col-lg-6 center-screen">
            <div className="card w-90 p-3">
              <div className="card-body">
                ...
                <input type="email" placeholder="User Email" className="form-control animated fadeInUp"/>
                <br />
